...
keyspace=$1
bkp_name="bkp-$$"
data_dir="/opt/cassandra/data/data"
...
nodetool -u cassandra -pw cassandra snapshot "${keyspace}" -t "${bkp_name}"
...
nodetool -u cassandra -pw cassandra clearsnapshot -t "${bkp_name}" "${keyspace}"
